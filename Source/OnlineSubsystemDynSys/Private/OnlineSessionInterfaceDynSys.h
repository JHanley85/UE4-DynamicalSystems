 ...
 */
class FOnlineSessionDynSys : public IOnlineSession
{
private:
	 ...
	 */
	void AppendSessionToPacket(class FNboSerializeToBufferDynSys& Packet, class FOnlineSession* Session);
	 ...
	 */
	void AppendSessionSettingsToPacket(class FNboSerializeToBufferDynSys& Packet, FOnlineSessionSettings* SessionSettings);
	 ...
	 */
	void ReadSessionFromPacket(class FNboSerializeFromBufferDynSys& Packet, class FOnlineSession* Session);
	 ...
	 * @param SessionSettings the session settings to copy the data to
	 */
	void ReadSettingsFromPacket(class FNboSerializeFromBufferDynSys& Packet, FOnlineSessionSettings& SessionSettings);
	 ...
	 */
	static void SetPortFromNetDriver(const FOnlineSubsystemDynSys& Subsystem, const TSharedPtr<FOnlineSessionInfo>& SessionInfo);
...
PACKAGE_SCOPE:
	...
	FOnlineSessionDynSys(class FOnlineSubsystemDynSys* InSubsystem) :
...
public:
	...
	public:
		TMap<uint8, FString > _ClassMap;
};

typedef TSharedPtr<FOnlineSessionDynSys, ESPMode::ThreadSafe> FOnlineSessionDynSysPtr;
